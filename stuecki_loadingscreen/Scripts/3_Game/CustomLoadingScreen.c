...
const string LOADING_SCREENS_PATH 	= "stuecki_loadingscreen/Data/LoadingImages.json";
const string LOADING_MESSAGES_PATH 	= "stuecki_loadingscreen/Data/LoadingMessages.json";
const string LOADING_SCREEN_LOGO 	= "stuecki_loadingscreen/Pictures/logo.edds";
									//! ModName/Path/File
...
const bool UseCustomLoadingBarColor = false;
